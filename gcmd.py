...
path1 = '.'
if(path.exists("cgd_gcmd.txt")):
    os.remove("cgd_gcmd.txt")
fo = open("cgd_gcmd.txt", "w+")
...
if(path.exists("cgd_gcmd_counts_levels.txt")):
    os.remove("cgd_gcmd_counts_levels.txt")

sys.stdout = open("cgd_gcmd_counts_levels.txt", "w")
